              ...
              if (isChecklistScreen) {
                return (
                  <>
                    ...
                    <div>
                      <Label error={isKeyDisabled || disabled ? undefined : !key || keyHasError} htmlFor="key">
                        Key *
                      </Label>
                      <Controller
                        control={control}
                ...
                return (
                  <>
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <Label secondary htmlFor="checked">
                        Mark as checked
                      </Label>
                    </div>
                  </>
                ...
                return (
                  <>
                    <div className="flex flex-col gap-y-5 sm:gap-y-0 sm:flex-row sm:gap-x-2 sm:items-center">
                      <div>
                        <Label error={isKeyDisabled || disabled ? undefined : !id} htmlFor="id">
                          ID *
                        </Label>
                        <Controller
                          control={control}
                        ...
                        <div className="flex items-center space-x-2">
                          <Switch
                            ...
                            onCheckedChange={(checked) =>
                              setValue("enterValueManually", checked, { shouldDirty: true })
                            }
                          />
                    ...
                    {isEdlizSummaryScreen && (
                      <>
                          ...
                          <div>
                            ...
                            {!!types.length && (
                              <a
                                ...
                                onClick={(e) => {
                                  e.preventDefault()
                                  setValue("type", isCustomType ? itemType || item?.type || "" : "", {
                                    shouldDirty: true,
                                  })
                        ...
                        <div>
                          ...
                          <div>
                            {isCustomSubType ? (
                              <Input {...register("subType", { disabled, required: false })} name="subType" />
                            ) : (
                              <Select
                                value={subType || ""}
                                disabled={disabled}
                        ...
                        <div>
                          ...
                          <Input {...register("score", { disabled, required: false })} name="score" type="number" />
                        </div>
