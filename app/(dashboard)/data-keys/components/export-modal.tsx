...
import { exportDataKeys } from '@/app/actions/data-keys';
...
export function ExportModal({ uuids, }: {
    ...
    const exportData = handleSubmit(async (formData) => {
        try {
            ...
            const response = await axios.post(`/api/data-keys/export`, { 
                ...formData,
                uuids,
            });
            const res = response.data as Awaited<ReturnType<typeof exportDataKeys>>;
