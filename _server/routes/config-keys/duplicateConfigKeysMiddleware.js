...
import { ConfigKey, Diagnosis, Screen } from '../../models';
...
export const copyConfigKey = ({ id }) => {
  return new Promise((resolve, reject) => {
    ...
    (async () => {
      ...
      try {
        savedConfigKey = await ConfigKey.findOrCreate({ where: { config_key_id: configKey.config_key_id }, defaults: { id: configKey.config_key_id, ...configKey } });
      } catch (e) { return reject(e); }
