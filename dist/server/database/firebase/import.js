  ...
  return new Promise(function (resolve, reject) {
    ...
    Promise.all([getData('configkeys'), getData('scripts'), getData('screens'), getData('diagnosis')]).then(function (_ref) {
      ...
      configKeys.forEach(function (_ref3, i) {
        ...
        return promises.push(_index.ConfigKey.findOrCreate({
          where: {
            id: id
          },
          defaults: {
      ...
      scripts.forEach(function (_ref4, i) {
        ...
        promises.push(_index.Script.findOrCreate({
          where: {
            id: script_id
          },
          defaults: {
        ...
        screens.forEach(function (_ref5, position) {
          ...
          position = position + 1;
          promises.push(_index.Screen.findOrCreate({
            where: {
              screen_id: screen_id,
              script_id: script_id
            },
        ...
        diagnosis.forEach(function (_ref6, position) {
          ...
          position = position + 1;
          promises.push(_index.Diagnosis.findOrCreate({
            where: {
              diagnosis_id: diagnosis_id,
              script_id: script_id
            },
