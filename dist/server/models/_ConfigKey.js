...
ConfigKey.afterUpdate(function (cKey) {
  ...
  _firebase["default"].database().ref("configkeys/".concat(id)).update(_objectSpread(_objectSpread(_objectSpread({}, data), c), {}, {
...
(function () {
  ...
  reactHotLoader.register(ConfigKey, "ConfigKey", "/home/farai/WorkBench/neotree-editor/server/models/_ConfigKey.js");
  reactHotLoader.register(_default, "default", "/home/farai/WorkBench/neotree-editor/server/models/_ConfigKey.js");
})();
