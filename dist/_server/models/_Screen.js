...
Screen.afterUpdate(function (script) {
  ...
  _firebase["default"].database().ref("screens/".concat(script.script_id, "/").concat(screen_id)).update(_objectSpread(_objectSpread(_objectSpread({}, data), scr), {}, {
...
(function () {
  ...
  reactHotLoader.register(Screen, "Screen", "/home/farai/WorkBench/neotree-editor/_server/models/_Screen.js");
  reactHotLoader.register(_default, "default", "/home/farai/WorkBench/neotree-editor/_server/models/_Screen.js");
})();
