...
var GET_SCRIPT = exports.GET_SCRIPT = '/get-script';
var GET_SCRIPTS = exports.GET_SCRIPTS = '/get-scripts';
var GET_FULL_SCRIPT = exports.GET_FULL_SCRIPT = '/get-full-script';
var GET_SCRIPT_ITEMS = exports.GET_SCRIPT_ITEMS = '/get-script-items';
var CREATE_SCRIPT = exports.CREATE_SCRIPT = '/create-script';
var UPDATE_SCRIPT = exports.UPDATE_SCRIPT = '/update-script';
var UPDATE_SCRIPTS = exports.UPDATE_SCRIPTS = '/update-scripts';
var DELETE_SCRIPTS = exports.DELETE_SCRIPTS = '/delete-scripts';
var DUPLICATE_SCRIPTS = exports.DUPLICATE_SCRIPTS = '/duplicate-scripts';
var GET_SCRIPT_DIAGNOSES_SCREENS = exports.GET_SCRIPT_DIAGNOSES_SCREENS = '/get-script-diagnoses-screens-count';
;
(function () {
